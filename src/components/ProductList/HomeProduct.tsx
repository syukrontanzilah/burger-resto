...
const HomeProduct: React.FC<HomeProductProps> = ({ onOpenDrawer }) => {
  return (
    <div className="grid md:grid-cols-3 gap-6">
      {/* Item 1 - Hot */}
      <div className="flex flex-col cursor-pointer" onClick={onOpenDrawer}>
        ...
        <p className="text-orange-600 font-semibold text-lg mt-3">39.000 IDR</p>
        <p className="text-base font-medium text-gray-900">Chicken Sandwich</p>
